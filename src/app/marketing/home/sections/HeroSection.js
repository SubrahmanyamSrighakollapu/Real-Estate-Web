...
export default function HeroSection() {
  return (
    <section
      style={{
        backgroundImage:
          'linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url("/hero-background.png")',
        ...
        position: 'relative',
        padding: '2rem',
        paddingBottom: '8rem', // reserve space for fixed card
      }}
    >
      {/* Hero Content */}
      <div
